    ...
    <div class="container">
        <div class="jumbotron">
            ...
            <?php session_start();?>
                ...
                <a type="button" class="btn btn-warning btn-block" id="viewJournal">View Selected Entry</a>
                <a type="button" class="btn btn-success btn-block" id="createJournal">New Entry</a>
        </div>
    </div>
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            function(data, status){
                ...
                var table = "<table class='table'><thead><tr><th>Title</th><th>Date Created</th></tr></thead><tbody class='row-select'><div class='btn-group' data-toggle='buttons'>";
